...
Public Class AgregarMascota
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles modificar.Click
        If validarTexto(NombreMascota) And validarTexto(comida) And validarTexto(raza) And validarNumero(peso) Then
            If tiposdehabitacion.selectedValue.Equals("Mini Suite") And peso.Text > 12 Then
                FormInfo.callFormWithMessage("¡El peso de la mascota tiene que ser menor o igual a 12!")
                Return
            End If
            If Not habitaciones.selectedIndex < 0 Then
                If fechaNac.Value < Today Then
                    ...
                    Close()
                Else
                    FormInfo.callFormWithMessage("¡La fecha de nacimiento de la mascota no puede ser mayor o igual a hoy!")
                End If
            Else
                FormInfo.callFormWithMessage("¡Eliga una habitación!")
            End If
        End If
    End Sub
    ...
    Public Function fill(dgv As DataGridView)
        ...
        If isPossible Then
            ...
            If dgv.Rows.Count = 0 Then
                ...
                Next
                If itemCount >= 3 Then
                    FormInfo.callFormWithMessage("¡Esta habitación esta llena, utilize otra!")
                    Return False
                End If
